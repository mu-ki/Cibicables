            ...
            <div class="container">
                <div class="card">
                    <div class="card-body" style=" background-color: #ffffff; ">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="de02c140-eb50-433b-bf2b-2d6e675f7019" method = "POST" action="insert-process.php">
                                    <div class="row">
                                        <div class=" col-md-12 ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name"
                                                        ...
                                                        id="field_27" required data-msg-required="Enter Customer Name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="number"
                                                        ...
                                                        data-msg-required="Enter Customer Number">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="telephone"
                                                        ...
                                                        id="field_12" data-msg-required="This field is required">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" name="ftthus"
                                                        ...
                                                        data-msg-required="Enter FTTH User Name">
                                        ...
                                        <div class=" col-md-5 ">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="ftthps"
                                                        placeholder="Enter FTTH Password" class="form-control  "
                                                        id="field_7" required data-msg-required="Enter Password">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="vlan"
                                                        ...
                                                        required data-msg-required="Enter VLan Id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="port"
                                                        ...
                                                        required data-msg-required="Enter Port Number">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="macid"
                                                        ...
                                                        id="field_23" data-msg-required="This field is required">
                        ...
                        ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="custom-select  " required
                                                        ...
                                                        name="operator">
                                                        <option  value = "Ananthi">
                                                            Ananthi
                                                        </option>
                                                        <option  value = "MyilSamy">
                                                            MyilSamy
                                                        </option>
                                                        <option value = "NemanthSamy">
                                                            NemanthSamy
                                                        </option>
                                                        <option value = "Ranjani">
                                                            Ranjani
                                                        </option>
                                                        <option value = "ThangaMuthu">
                                                            ThangaMuthu
                                                        </option>
                                                    </select>
                                                    <div class="input-group-append">
                                        ...
                                        <div class=" col-md-4 ">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="field_20" data-target-input="nearest">
                                                    <input type="text" name="connectiondate"
                                                        data-toggle="datetimepicker" id="field_20"
                                                        class="form-control datetimepicker-input " readonly
                                                        data-target="#field_20" required
                                                        data-msg-required="This field is required">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" data-target="#field_20"
                                        ...
                                        <div class=" col-md-3 ">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="commisionamount"
