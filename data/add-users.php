...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($name==""){
		...
		header('location:'.$_SERVER['PHP_SELF'].'?msg=ut');
		exit;
	}elseif($vlan==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=uv');
		exit;
	}elseif($musername==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=umu');
		exit;
	}elseif($mpassword==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=ump');
		exit;
	}elseif($ftthusername==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=ufu');
		exit;
	}elseif($ftthpassword==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=ufp');
		exit;
	}elseif($wifiname==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=uwn');
		exit;
	}elseif($wifipassword==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=uwp');
		exit;
	}else{
					...
					<form method="post">
						<div class="form-group">
							...
							<div class="fieldBlock">
								...
								<input type="number" class="tel form-control" name="telephone" id="telephone"
						...
						<div class="fieldBlock1">
							...
							<input type="text" name="musername" id="musername" class="form-control"
						...
						<div class="fieldBlock1">
							...
							<input type="email" name="ftthusername" id="ftthusername" class="form-control"
						...
						<div class="fieldBlock1">
							...
							<input type="text" name="ftthpassword" id="ftthpassword" class="form-control"
