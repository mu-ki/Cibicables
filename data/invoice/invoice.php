...
<span class="hide"><br><a class="button" href='index.php'>BACK</a>

<a class="button1" onClick="window.print()">PRINT</a>
...
<table class="allHalfTd">
	<tr class="fullWidth">
		<td>
			...
			?>
			<br><br>
			Adress: <span class="yourBank"><?php echo isset($_SESSION['bankName']) ? ($_SESSION['bankName']) : '' ?></span><br>
			Contact No.: <span class="yourPhone"><?php echo isset($_SESSION['yourPhone']) ? $_SESSION['yourPhone'] : '' ?></span>
			<?php
			...
			<table>
				<!-- <tr class="fullWidth">
					<td class="grayscale fullWidth tenPadding alignTop">
						<b>Total Amount (INR) <span class="pull-right totalAmount">&#8377; <?php echo numberToCurrency($finalAmount); ?></span></b>
					</td>
				</tr> -->
			</table>
		</td>
		...
		<td>
			...
			<table class="allFullTr allHalfTd">
				...
				<tr class="grayscale tenPadding">
					<td class="tenPadding"><b>Grand Total (INR)</b></td>
