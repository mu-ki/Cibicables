...
<div class="fieldBlock">
		...
		<input type="text" name="username" id="username" class="form-control" value="<?php echo $row[0]['name']; ?>" placeholder="Enter user name" required>
	...
	<div class="fieldBlock">
		...
		<input type="tel" class="tel form-control" name="userphone" id="userphone" x-autocompletetype="tel" placeholder="Enter Telephone Number Without STD" required>
	...
	<div class="fieldBlock">
		...
		<input type="text" name="vlan" id="vlan" class="form-control" placeholder="Enter Vlan Id" required>
	...
	<div class="fieldBlock1">
		...
		<input type="text" name="modemusername" id="modemusername" class="form-control" placeholder="Enter Modem User name" required>
	...
	<div class="fieldBlock1">
		...
		<input type="email" name="modempassword" id="modempassword" class="form-control" placeholder="Enter Modem password" required>
	...
	<div class="fieldBlock1">
		...
		<input type="text" name="ftthusername" id="ftthusername" class="form-control" placeholder="Enter Ftth User name" required>
	...
	<div class="fieldBlock1">
		...
		<input type="text" name="ftthpassword" id="ftthpassword" class="form-control" placeholder="Enter Ftth Password" required>
	...
	<div class="fieldBlock1">
		...
		<input type="text" name="wifiname" id="wifiname" class="form-control" placeholder="Enter Wifi name" required>
	...
	<div class="fieldBlock1">
		...
		<input type="text" name="wifipassword" id="wifipassword" class="form-control" placeholder="Enter Wifi Password" required>
